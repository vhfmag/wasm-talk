...
<p><small>Victor Magalhães (@vhfmag) — wasm-talk.netlify.com</small></p>
...
<Notes>
  <q>"Por quê? Por que mais uma linguagem na Web? O que falta em Javascript?</q>
</Notes>
...
- Parsear Javascript é custoso
  ...
  - [asm.js](https://asmjs.org/) é rápido de executar, mas lento de parsear
