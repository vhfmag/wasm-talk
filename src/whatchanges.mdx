...
> <q>[Olin](https://github.com/Xe/olin) é uma tentativa de definir um primitivo de operação radicalmente novo para tornar mais fácil raciocinar sobre, fazer deploy e operar serviços orientados a evento e que seja independente do SO e da CPU do computador em que ele esteja rodando.</q><br/>— https://christine.website/blog/olin-1-why-09-1-2018

<!-- esse comentário é um hack pra separar os blockquotes sem ofender o prettier :( -->

> <q>Eu quero que este projeto dure décadas. Eu quero que os binários que eu suba hoje continuem funcionando daqui a 5 anos, assumindo que suas dependências além desse módulo continuem funcionando.</q><br/>— https://github.com/Xe/olin
...
> Ao invés de usar a EVM, nós agora temos um excelente e eficiente conjunto de instruções, pro qual se pode compilar todos os tipos de linguagens e ter confiança de que ele vai ser executável e igualmente performático em diferentes tipos de plataformas  —  ideal pra aplicações decentralizadas!
>
> Não só dApps vão ficar mais rápidos em produção, como a integração do WASM vai tornar o desenvolvimento de _Smart Contracts_ mais acessível para pessoas já familiares com linguagens como Rust e Go.
>
